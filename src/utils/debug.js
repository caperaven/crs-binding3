export class Debug {
    ...
    /**
     * 1. What are the properties bound to on this element.
     * 2. What is the value on the context for that property path.
     * 3. What are the providers for that property path.
     * @param element
     * @returns {*[]}
     */
...
async function getAttributeIntent(element, results) {
    ...
    for (const providerKey of Object.keys(providers)) {
        ...
        if (elementStoreItem == null) continue;
