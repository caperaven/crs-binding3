/**
 * Process the conditional default for a field
 * This will generate the required code and register a callback with the binding engine.
 * @param bid
 * @param fieldName
 * @param definition
 * @returns {Promise<void>}
 */
export async function processFieldConditionalDefaults(bid, fieldName, definition) {
